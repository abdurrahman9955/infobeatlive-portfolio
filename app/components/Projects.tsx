...
const projectsData: Project[] = [
  {
    ...
    githubFrontend: "https://github.com/example/infobeat-analytics-fe",
    githubBackend: "https://github.com/example/infobeat-analytics-be",
    users: "6,000+",
    revenue: "$12,570+",
    profits: "$-5,530",
    status: "Shut down",
  ...
  },
  {
    ...
    liveDemo: "https://schools.infobeatlive.site",
    githubFrontend: "https://github.com/example/infobeat-schools-fe",
    githubBackend: "https://github.com/example/infobeat-schools-be",
  ...
  },
  {
    ...
    liveDemo: "#",
    githubFrontend: "https://github.com/example/infobeat-learn-fe",
    githubBackend: "https://github.com/example/infobeat-learn-be",
    users: "12,300+",
    revenue: "$7,600+",
    profits: "$-2,476",
    status: "Shut down",
